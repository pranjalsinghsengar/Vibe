...
//       try {
//         const response = await axios.get(`${apiurl}/api/whatsapp/user/user`, {
...
//             <h1 className="text-3xl font-extrabold text-primary sm:text-4xl">Account Dashboard</h1>
//             <p className="mt-2 text-text-secondary text-lg">Manage your account settings and preferences</p>
//           </div>
...
//                     </div>
//                     {userAccountData.user.userType === 'admin' && (
...
//                       <p className="text-4xl font-bold tracking-tight drop-shadow">{userAccountData.user.wallet}</p>
//                     </div>

//                     <div className="flex justify-between items-center text-xs border-t border-white/30 pt-4">
//                       <span className="font-medium">{userAccountData.tanent_details.name}</span>
//                       <Link to="/plans">
...
//                       <p className="text-text-primary font-medium">{userAccountData.tanent_details.name}</p>
//                     </div>
//                     <div>
//                       <p className="text-xs text-text-secondary">Subscription Plan</p>
//                       <p className="text-text-primary font-medium capitalize">
//                         {userAccountData.tanent_details.subscription.plan} ({userAccountData.tanent_details.subscription.status})
//                       </p>
//                     </div>
//                     <div>
...
//                           <p className="text-text-secondary text-sm">{account.PHONE_NUMBER}</p>
//                         </div>
...
function Account() {
  ...
  useEffect(() => {
    const fetchSuperadminData = async () => {
      try {
        ...
        // Fetch banking details for superadmin
        ...
        // Set bankForm with fetched banking details
        setBankForm({
  ...
  // Update bankForm when entering edit mode
  useEffect(() => {
          ...
          {userAccountData && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-md p-6 border border-accent/50 hover:shadow-lg transition-all text-left">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className='px-3'>
                    ...
                    <span className="inline-block mt-2 bg-light-primary/20 text-light-primary py-1 rounded-full text-xs font-medium capitalize">
                      {userAccountData?.user?.userType || 'N/A'}
                    </span>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                {/* Banking Details (Superadmin only) */}
                {userData?.userType === 'superadmin' && bankingDetails && (
                  <div className="bg-white rounded-2xl shadow-md p-6 border border-accent/50 hover:shadow-lg transition-all text-left relative">
                    <h3 className="text-lg font-semibold text-text-primary mb-4 flex items-center gap-2">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full p-2 border border-accent/50 rounded-lg"
                          />
                        </div>
                        <div>
