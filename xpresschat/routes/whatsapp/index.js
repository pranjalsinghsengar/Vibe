...
import {sendTextMessage, assignTicket, createTicket, getMyTickets, getTicketById, getTicketsByTenantObjId, getTicketsByUserObjId } from "./controller/index.js";

const ticketRouter = Router();
ticketRouter.post('message/text',sendTextMessage)
